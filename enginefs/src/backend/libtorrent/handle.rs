...
impl TorrentHandleTrait for LibtorrentTorrentHandle {
    ...
    async fn get_file_reader(
        ...
        // MULTI-FILE FIX: Clear all piece deadlines to prevent stale deadlines
        // from previous file streams competing for bandwidth
